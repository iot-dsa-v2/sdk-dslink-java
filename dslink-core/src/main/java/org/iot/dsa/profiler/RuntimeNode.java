...
public class RuntimeNode extends MXBeanNode {
	...
	public void refreshImpl() {
    	...
    	for (Entry<String, String> entry: properties.entrySet()) {
			systemNode.put(entry.getKey(), DSString.valueOf(entry.getValue())).setReadOnly(true).setTransient(true);
		}
    	putProp("StartTime", DSString.valueOf(Instant.ofEpochMilli(mxbean.getStartTime()).toString()));
