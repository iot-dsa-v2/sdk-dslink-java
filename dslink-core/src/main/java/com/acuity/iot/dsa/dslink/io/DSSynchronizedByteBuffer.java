 ...
 * @author Aaron Hansen
 */
public class DSSynchronizedByteBuffer {
    ...
    public DSSynchronizedByteBuffer() {
        this(8192);
    }

    public DSSynchronizedByteBuffer(int initialCapacity) {
     ...
     */
    public synchronized DSSynchronizedByteBuffer close() {
        if (!open) {
            return this;
        }
        open = false;
     ...
     * Important for notifying waiting threads.
     */
    public synchronized DSSynchronizedByteBuffer close(RuntimeException toThrow) {
        if (!open) {
            return this;
        }
    ...
    public synchronized DSSynchronizedByteBuffer open() {
        if (open) {
            return this;
        }
        length = 0;
     ...
     * @return This
     */
    public DSSynchronizedByteBuffer setTimeout(long timeout) {
